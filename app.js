...
const aboutContent2 = "I started my career in Product Management at eVision Industry Software (now Enablon/Wolters Kluwer), where I got to manage my own product team and created a product from scratch in collaboration with major companies, such as Exxon, Shell, and BP. After that, I decided to pursue a start-up adventure as the product lead of Woov, a live music platform. Despite the pandemic, we enhanced the platform that enabled monetization of our business model through digital payment & music right tracking. "
