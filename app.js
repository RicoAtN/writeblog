...
app.get("/", function(req, res) {
  res.render("home", {
    firstParagraph: homeStartingContent, blogContents: allPosts
  }); 
});
...
app.get("/post/:postTitle", function(req, res) {
  ...
  allPosts.forEach(function(newPost) {
    const storedTitle = _.lowerCase(newPost.title);

  if (storedTitle === requestedTitle) {

    res.render("post", {
      individualPostTitle: newPost.title, individualPostContent: newPost.content
    });
